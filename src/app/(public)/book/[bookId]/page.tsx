      ...
      <div className="flex">
        ...
        <div className="ml-6">
          ...
          <div className="relative inline-block" ref={dropdownRef}>
            ...
            {isMenuVisible && (
              <div
                className={`absolute bottom-full -mb-2 right-0 w-64 bg-white text-black shadow-lg rounded-lg border border-gray-300 z-10 transform transition-all duration-300 ease-out ${
                  isMenuVisible
